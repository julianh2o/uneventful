...
export const EventDashboard = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{data.eventName || 'Event'} | {APP_TITLE}</title>
      </Helmet>
      <Box sx={{ p: 3 }}>
        {/* Header */}
        <Paper
        ...
        <Paper sx={{ p: 3, mb: 3, textAlign: 'center' }}>
          ...
          {!countdown.passed && (
            <CountdownDisplay days={countdown.days} hours={countdown.hours} />
          )}
          {countdown.passed && (
        ...
        <Paper sx={{ mb: 3 }}>
          <List dense>
            ...
            <InfoRow icon={<GroupsIcon color="success" />} label="Party Size" value={data.partySize || 'Not specified'} />
            <InfoRow icon={<PersonIcon color="info" />} label="Host" value={data.hostName || 'Not specified'} />
            <InfoRow icon={<ContactIcon color="warning" />} label="Contact" value={data.hostContact || 'Not specified'} />
